...
<body>
<h1 style="text-align: center; font-size: 50px;"> Login page </h1>
<br>
<br>
<br>
<br>
...
if (isset($_POST['register'])) {
	...
	$con = mysqli_connect("127.0.0.1:3307","root","","loginpage");
  ...
  else
	{
		...
		$query="SELECT * FROM mytable WHERE Email='$txtEmail' ";
		...
		else
		{
                ...
                { 
	        $sql = "INSERT INTO `mytable` (`Id`, `Email`, `Password`,`Rpassword`) VALUES ('0','$txtEmail', '$txtPassword','$txtRpassword')";		
...
{
  session_start();
	$conn = mysqli_connect("127.0.0.1:3307","root","","loginpage");
	...
	else
	{
		...
		{
      $query="SELECT * FROM mytable WHERE Email='$txtEmail' and Password='$txtPassword'";
        $run=mysqli_query($conn,$query);
  ...
  {
    echo"<script src='message10.js'></script>";
  }
}
